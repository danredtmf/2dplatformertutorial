...
Попробуем на уровне подобрать монету и через режим расположения монеты (нажать на `Q`) расположить монету (нажать на `E`) в мире так, чтобы она точно коснулась врага. Враг должен погибнуть.

...
## Загадка "Соединение связей": Игровой предмет
...
## Загадка "Соединение связей": Интерфейс (Часть 1)
...
## Загадка "Соединение связей": Вспомогательный объект
...
## Загадка "Соединение связей": Интерфейс (Часть 2)
...
## Изменение базового уровня `BaseLevel`
